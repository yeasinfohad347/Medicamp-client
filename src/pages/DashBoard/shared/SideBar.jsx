...
const SideBar = ({ role, onClose }) => {
  return (
    <div className="w-64 min-h-screen bg-primary text-white flex flex-col">
      ...
      <div className="flex items-center justify-center py-6 border-b border-white/30 sm:flex hidden">
      ...
      <nav className="flex flex-col p-4 space-y-2">
        ...
        {role === "admin" && (
          <>
            ...
            <NavLink
              to="/dashboard/admin/manage-camps"
              className="btn btn-ghost justify-start"
              onClick={onClose}
            >
            ...
            <NavLink
              to="/dashboard/admin/manage-registered"
              className="btn btn-ghost justify-start"
              onClick={onClose}
            >
        ...
        {role === "user" && (
          <>
            ...
            <NavLink
              to="/dashboard/user/manage-camps"
              className="btn btn-ghost justify-start"
              onClick={onClose}
            >
